...
require_once(gavern_file('gavern/widgets.news_gallery.php'));
require_once(gavern_file('gavern/widgets.news_blocks.php'));
require_once(gavern_file('gavern/widgets.nsp.php'));
require_once(gavern_file('gavern/widgets.product_gallery.php'));
