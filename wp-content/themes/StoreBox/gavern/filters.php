...
/**
 *
 * Code used to implement markdown in the widget titles
 *
 * @return null
 * 
 **/
function gk_title_html($title) {
	return preg_replace('/\*\*(.*?)\*\*/i', '<em>${1}</em>', preg_replace('/__(.*?)__/i', '<strong>${1}</strong>', $title));
}

add_filter('widget_title', 'gk_title_html');
